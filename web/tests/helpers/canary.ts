 ...
 * (see backend/tests/e2e/fakes/fixtures/drive_files.json).
...
export const CANARY_TOKENS = {
	driveCanaryFile: "CORVOS_E2E_CANARY_TOKEN_DRIVE_001",
	drivePdfCanary: "CORVOS_E2E_CANARY_TOKEN_DRIVE_PDF_001",
	composioDrivePdfCanary: "CORVOS_E2E_CANARY_TOKEN_COMPOSIO_DRIVE_PDF_001",
	driveReadme: "CORVOS_E2E_README_MARKER",
	driveBudget: "CORVOS_E2E_BUDGET_MARKER",
	driveRoadmap: "CORVOS_E2E_ROADMAP_MARKER",
	driveArchive: "CORVOS_E2E_ARCHIVE_MARKER",
	gmailCanary: "CORVOS_E2E_CANARY_TOKEN_GMAIL_001",
	calendarCanary: "CORVOS_E2E_CANARY_TOKEN_CALENDAR_001",
	onedriveCanary: "CORVOS_E2E_CANARY_TOKEN_ONEDRIVE_001",
	onedrivePdfCanary: "CORVOS_E2E_CANARY_TOKEN_ONEDRIVE_PDF_001",
	dropboxCanary: "CORVOS_E2E_CANARY_TOKEN_DROPBOX_001",
	dropboxPdfCanary: "CORVOS_E2E_CANARY_TOKEN_DROPBOX_PDF_001",
	notionCanary: "CORVOS_E2E_CANARY_TOKEN_NOTION_001",
	confluenceCanary: "CORVOS_E2E_CANARY_TOKEN_CONFLUENCE_001",
	linearCanary: "CORVOS_E2E_CANARY_TOKEN_LINEAR_001",
	jiraCanary: "CORVOS_E2E_CANARY_TOKEN_JIRA_001",
	slackCanary: "CORVOS_E2E_CANARY_TOKEN_SLACK_001",
	clickupCanary: "CORVOS_E2E_CANARY_TOKEN_CLICKUP_001",
...
export const FAKE_NOTION_PAGES = {
	canary: {
		...
		workspaceName: "Corvos E2E Notion Workspace",
...
export const FAKE_CONFLUENCE_PAGES = {
	canary: {
		...
		baseUrl: "https://corvos-e2e-confluence.atlassian.net",
	},
} as const;
...
export const FAKE_LINEAR_ISSUES = {
	canary: {
		...
		organizationName: "Corvos E2E Linear Org",
		organizationUrlKey: "corvos-e2e",
	},
} as const;
...
export const FAKE_JIRA_ISSUES = {
	canary: {
		...
		siteUrl: "https://corvos-e2e.atlassian.net",
	},
} as const;
...
export const FAKE_SLACK_CHANNELS = {
	canary: {
		...
		teamName: "Corvos E2E Slack Workspace",
	},
} as const;
...
export const FAKE_CLICKUP_TASKS = {
	canary: {
		...
		workspaceName: "Corvos E2E ClickUp Workspace",
	},
} as const;
