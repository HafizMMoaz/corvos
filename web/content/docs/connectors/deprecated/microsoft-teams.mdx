...
description: Connect your Microsoft Teams to Corvos
---

# Microsoft Teams OAuth Integration Setup Guide

This guide walks you through setting up a Microsoft Teams OAuth integration for Corvos using Azure App Registration.
...
4. Enter a description (e.g., `Corvos`) and select an expiration period
5. Click **"Add"**
...
## Running Corvos with Microsoft Teams Connector
