---
title: Elasticsearch
description: Connect your Elasticsearch cluster to Corvos
---
...
This guide walks you through connecting your Elasticsearch cluster to Corvos.

## How it works

The Elasticsearch connector allows you to search and retrieve documents from your Elasticsearch cluster. Configure connection details, select specific indices, and set search parameters to make your existing data searchable within Corvos.
...
- **Connection Timeout:** Check your network connectivity and firewall settings. Ensure the Elasticsearch cluster is accessible from Corvos servers.
