---
title: Discord
description: Connect your Discord servers to Corvos
---
...
This guide walks you through setting up a Discord OAuth integration for Corvos.
...
3. Enter the application name: `Corvos`
4. Click **"Create"**
...
<Callout type="warn">
   Keep **Public Client** disabled (off) since Corvos uses a server to make requests.
</Callout>
...
## Running Corvos with Discord Connector
