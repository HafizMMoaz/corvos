...
description: Import your OneDrive files into the Corvos knowledge base
---
...
<Callout type="info">
This setup is only needed on **self-hosted** deployments. On Corvos Cloud, just use **Import → OneDrive**.
</Callout>
...
3. Enter a description (e.g., `Corvos`) and pick an expiration period
4. Click **"Add"**
...
## Step 5: Add the Credentials to Corvos
...
Restart Corvos, open **Documents → Import → OneDrive**, and authorize:
