---
title: Dropbox
description: Import your Dropbox files into the Corvos knowledge base
---
...
<Callout type="info">
This setup is only needed on **self-hosted** deployments. On Corvos Cloud, just use **Import → Dropbox**.
</Callout>
...
| **Name your app** | `Corvos` (or any unique name) |
...
Restart Corvos, open **Documents → Import → Dropbox**, and authorize:
