---
title: Connectors
description: Connect Corvos to your tools and services
---

import { Card, Cards } from 'fumadocs-ui/components/card';
import { Zap, Cable } from 'lucide-react';

Connectors bring data into Corvos - either as searchable knowledge or as live tools the AI agent can use during chat. There are two kinds:

<Cards>
  <Card
    icon={<Zap />}
    title="Native Connectors"
    description="Corvos's built-in scraper APIs: Reddit, YouTube, Instagram, TikTok, Google Maps, Google Search, Indeed, Amazon, Walmart, and Web Crawl - usable in chat, the API Playground, or via REST"
...
## How connectors surface in Corvos
...
- **Integrations** - external connectors like Notion, Slack, Jira, or Linear give the agent real-time tools. Ask a question in chat and the agent searches or acts on the connected service directly; nothing is copied into Corvos in the background.
