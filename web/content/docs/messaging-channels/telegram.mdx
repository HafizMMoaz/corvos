...
Telegram lets users chat with the Corvos agent from a Telegram bot. Users pair
...
3. Corvos provides a pairing code or bot link.
4. The user sends the pairing command to the Telegram bot.
5. Corvos binds that Telegram chat to the selected workspace.
