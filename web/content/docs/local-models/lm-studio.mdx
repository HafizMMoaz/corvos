---
title: LM Studio
description: Connect LM Studio to Corvos
---
...
Use this when Corvos is running from Docker and LM Studio is running on your computer.
...
Use this when Corvos and LM Studio both run directly on the same computer.
...
Corvos discovers models from `/v1/models`. If you enter the URL without `/v1`, Corvos adds it for requests.
...
Load a model in LM Studio, then refresh model discovery in Corvos.
