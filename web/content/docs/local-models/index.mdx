---
title: Local Models
description: Connect local model servers to Corvos
---
...
Corvos can use local model servers such as Ollama and LM Studio.

The API Base URL is read by the Corvos backend. If Corvos runs in Docker, use an address the backend container can reach.
