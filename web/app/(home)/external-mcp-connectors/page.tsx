...
const canonicalUrl = "https://www.corvos.com/external-mcp-connectors";

const metaDescription =
	"External MCP connectors let your Corvos agents use any MCP server. Paste a config, tools are auto-discovered, and every call runs with per-tool approval. Try it free.";

export const metadata: Metadata = {
	title: "External MCP Connectors: Add Any MCP Server | Corvos",
	...
	openGraph: {
		...
		type: "website",
		images: [
			{ url: "/og-image.png", width: 1200, height: 630, alt: "Corvos external MCP connectors" },
		],
	},
	twitter: {
...
const STEPS = [
	...
	},
	{
		...
		description:
			"Corvos tests the connection and pulls the full tool list from the server. No manual tool configuration, no schema files to maintain.",
	},
	{
		icon: ShieldCheck,
...
const FAQ: FaqItem[] = [
	{
		...
		answer:
			"An external MCP connector links Corvos to an outside MCP (Model Context Protocol) server, so your agents can call that server's tools. You add a server config once, its tools are auto-discovered, and every agent in your workspace can use them with per-tool approval.",
	},
	{
		question: "How is this different from the Corvos MCP server?",
		answer:
			"Direction. External MCP connectors make Corvos the client: outside tools flow into your Corvos agents. The Corvos MCP server is the reverse: it exposes your workspace and the scraper APIs as tools inside Claude, Cursor, or any MCP client you already run.",
	},
	{
	...
	},
	{
		...
		answer:
			"Every MCP tool runs through Corvos's permission layer. Read-only tools are allowed automatically, while any tool that can write or act asks for your approval before it executes. You can mark tools you rely on as trusted so they skip the prompt on later calls.",
	},
	{
		question: "Can I connect Notion or Slack without writing a config?",
		answer:
			"Yes. Notion, Slack, Jira, Confluence, Linear, ClickUp, and Airtable connect through their official hosted MCP servers with one-click OAuth. Corvos handles the token exchange and curates each app's tool list, so you sign in once and your agents can use them immediately.",
	},
];
		...
		<>
			<JsonLd
				data={{
					...
					name: "Corvos External MCP Connectors",
			...
			<div className="pb-4">
					...
					<div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
						<div>
							...
							<p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
								External MCP connectors turn your Corvos workspace into an MCP client. Add any MCP
				...
				<MarketingSection>
					<Reveal>
						...
						<p className="mt-3 max-w-2xl text-muted-foreground leading-relaxed">
							...
							Corvos manages the tokens and curates each tool list, so your agents can search
				...
				<MarketingSection>
					<Reveal>
						<h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
							External MCP connectors vs the Corvos MCP server
						</h2>
						<p className="mt-3 max-w-2xl text-muted-foreground leading-relaxed">
							They are two sides of the same protocol. The external MCP connectors on this page make
							Corvos a <em>client</em>: they consume tools from outside MCP servers. The{" "}
							<Link
								href="/mcp-server"
					...
					<Reveal>
						<div className="rounded-2xl border bg-card p-8 text-center sm:p-12">
							...
							<p className="mx-auto mt-3 max-w-xl text-muted-foreground leading-relaxed">
								External MCP connectors are part of the Corvos{" "}
							...
							<nav aria-label="Other connectors" className="flex flex-wrap justify-center gap-2">
								...
								<Button asChild variant="ghost" size="sm">
									<Link href="/mcp-server">Corvos MCP Server</Link>
								</Button>
								<Button asChild variant="ghost" size="sm">
