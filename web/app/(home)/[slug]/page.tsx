...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
	...
	if (!content) return { title: "Connector Not Found | Corvos" };

	const canonicalUrl = `https://www.corvos.com/${content.slug}`;
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `${content.cardTitle ?? `${content.name} API`} on Corvos`,
				},
			],
		},
		twitter: {
