...
export const metadata: Metadata = {
	title: "Privacy Policy | Corvos",
	description:
		"Privacy Policy for Corvos. Learn how we collect, use, and protect your data when you use the Corvos website and application.",
	alternates: {
		canonical: "https://www.corvos.com/privacy",
	},
};
		...
		<div className="container max-w-4xl mx-auto py-12 px-4">
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p>
						Welcome to Corvos ("Corvos", "we", "us", or "our"). We operate the website at{" "}
						<a href="https://www.corvos.com">www.corvos.com</a> and the Corvos application
						(collectively, the "Service"), and we also publish Corvos as open-source software that
				...
				<section className="mb-8">
					...
					<ul className="list-disc pl-6 my-4 space-y-2">
						...
						<li>
							...
							model providers (see Section 7) and return the responses to you.
						</li>
						<li>
				...
				<section className="mb-8">
					...
					<p>
						...
						your preferences, and measure usage. This includes strictly necessary cookies (for
						authentication, session management, and security) and analytics cookies (we use PostHog
						for product analytics). We do not run advertising on the Service and do not use
						advertising cookies.
					</p>
					<p className="mt-4">
				...
				<section className="mb-8">
					...
					<p className="mt-4">
						...
						responsible for keeping your account credentials confidential. If you discover a
						vulnerability, please report it per our{" "}
						<a href="https://github.com/HafizMMoaz/Corvos/security">Security Policy</a>.
					</p>
				</section>
				...
				<section className="mb-8">
					<h2 className="text-2xl font-semibold mb-4">8. Your Legal Rights (Including GDPR)</h2>
					<p>
					...
					<p className="mt-4">
						To exercise any of these rights, please contact us using the details in Section 11. We
						may need to verify your identity before responding to your request.
					</p>
				</section>

				<section className="mb-8">
					<h2 className="text-2xl font-semibold mb-4">9. California Residents (CCPA / CPRA)</h2>
					<p>
					...
					<p className="mt-4">
						...
						To exercise your CCPA rights, please contact us using the details in Section 11.
					</p>
				</section>
