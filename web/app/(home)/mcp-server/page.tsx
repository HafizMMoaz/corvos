...
const canonicalUrl = "https://www.corvos.com/mcp-server";

const metaDescription =
	"The Corvos MCP server gives Claude, Cursor, and any MCP client native tools for your workspace: scrape Reddit, YouTube, Instagram, TikTok, Amazon, Walmart, Google Maps, Google Search, and the web, plus full knowledge base access. One API key.";

export const metadata: Metadata = {
	title: "Corvos MCP Server: Scraper APIs and Knowledge Base as Agent Tools",
	...
	openGraph: {
		...
		siteName: "Corvos",
		type: "website",
		images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Corvos MCP server" }],
	},
	twitter: {
...
const STEPS = [
	{
		...
		description:
			"In Corvos, go to Settings, then API, and create a key. Enable API access on the workspaces you want your agents to reach. That key is all the server needs.",
	},
	{
		icon: TerminalSquare,
		title: "Add the server to your client",
		description:
			"Point your client at https://mcp.corvos.com/mcp with your key in an Authorization header - the hosted config for Cursor, Claude Code, and others is one paste. Prefer stdio? Switch to Self-host and run it against your own backend.",
	},
	{
		icon: Server,
...
/** Mirrors the tool registry in mcp (see its README). */
const TOOL_GROUPS = [
	{
		icon: Server,
		title: "Live scrapers",
		...
		tools: [
			"corvos_reddit_scrape",
			"corvos_youtube_scrape",
			"corvos_youtube_comments",
			"corvos_instagram_scrape",
			"corvos_instagram_details",
			"corvos_tiktok_scrape",
			"corvos_tiktok_comments",
			"corvos_tiktok_user_search",
			"corvos_tiktok_trending",
			"corvos_google_maps_scrape",
			"corvos_google_maps_reviews",
			"corvos_google_search",
			"corvos_amazon_scrape",
			"corvos_walmart_scrape",
			"corvos_walmart_reviews",
			"web_crawl",
			"corvos_list_scraper_runs",
	...
	},
	{
		...
		description: "Read and write the same knowledge base your Corvos agents use.",
		tools: [
			"corvos_search_knowledge_base",
			"corvos_list_documents",
			"corvos_get_document",
			"corvos_add_document",
			"corvos_upload_file",
			"corvos_update_document",
			"corvos_delete_document",
		],
	},
	{
		icon: KeyRound,
		...
		tools: ["corvos_list_workspaces", "corvos_select_workspace"],
	},
] as const;

const FAQ: FaqItem[] = [
	{
		question: "What is the Corvos MCP server?",
		answer:
			"It is a Model Context Protocol server that exposes your Corvos workspace to MCP clients like Claude Code, Cursor, and Claude Desktop. Your agents get native tools for every scraper API (Reddit, YouTube, Instagram, TikTok, Amazon, Walmart, Google Maps, Google Search, web crawl) and for searching, reading, and writing your knowledge base.",
	},
	{
		question: "Which MCP clients does it work with?",
		answer:
			"Any MCP client that speaks remote (streamable HTTP) or stdio. Claude Code, Codex, OpenCode, Cursor, Claude Desktop, VS Code, Windsurf, and Gemini CLI all have copy-paste configs on this page - Hosted for the one-paste https://mcp.corvos.com/mcp endpoint, or Self-host for stdio against your own backend.",
	},
	{
	...
	{
		question: "Does it work with a self-hosted Corvos?",
		answer:
			"Yes. The server talks to Corvos purely over its REST API and imports no backend code, so pointing CORVOS_BASE_URL at your own instance is all it takes. It works with the cloud at api.corvos.com the same way.",
	},
	{
		...
		<>
			<JsonLd
				data={{
					...
					isPartOf: { "@type": "WebSite", name: "Corvos", url: "https://www.corvos.com" },
				}}
			/>
			...
			<div className="pb-4">
						...
						<div>
							<BreadcrumbNav
								...
								items={[
									...
									{ name: "Corvos MCP Server", href: "/mcp-server" },
								]}
							/>
							...
							<h1 className="text-3xl font-bold tracking-tight text-balance sm:text-4xl lg:text-5xl">
								Give your agents Corvos as native tools
							</h1>
							<p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
								The Corvos MCP server hands Claude, Cursor, or any MCP client the whole platform:
							...
							<div className="mt-8 flex flex-wrap items-center gap-3">
								...
								<Button asChild variant="ghost" size="lg">
									<Link
										href="https://github.com/HafizMMoaz/Corvos"
										target="_blank"
				...
				<MarketingSection>
					<Reveal>
						...
						<p className="mt-3 max-w-2xl text-muted-foreground leading-relaxed">
							The server is a thin layer over the Corvos REST API: the same endpoints, the same
				...
				<MarketingSection>
					<Reveal>
						<h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
							The Corvos MCP server vs external MCP connectors
						</h2>
						<p className="mt-3 max-w-2xl text-muted-foreground leading-relaxed">
							They are two sides of the same protocol. The MCP <em>server</em> on this page pushes
							Corvos tools out to agents you already run in Claude, Cursor, or your own harness.{" "}
							<Link
							...
							do the reverse: they pull outside tools like Notion, Slack, and Jira into your Corvos
				...
				<MarketingSection>
					<Reveal>
						<h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
							Corvos MCP server: frequently asked questions
						</h2>
					</Reveal>
					<Reveal>
					...
					<Reveal>
						<div className="rounded-2xl border bg-card p-8 text-center sm:p-12">
							...
							<p className="mx-auto mt-3 max-w-xl text-muted-foreground leading-relaxed">
								The MCP server is part of the Corvos{" "}
