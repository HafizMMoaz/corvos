...
export const metadata: Metadata = {
	title: "Free AI Chat, No Login Required | Corvos",
	description:
	...
	alternates: {
		canonical: "https://www.corvos.com/free",
	},
	openGraph: {
		title: "Free AI Chat, No Login Required | Corvos",
		description:
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "Corvos - ChatGPT Free Online, Claude AI Free, No Login Required",
			},
		],
	},
	twitter: {
...
const FAQ_ITEMS = [
	{
		...
		answer:
			"Yes. Corvos lets you use ChatGPT without login or any sign-up. Just pick a model and start chatting. No email, no password, no account needed. You get 500,000 free tokens to use across ChatGPT, Claude AI, Gemini, and other models.",
	},
	{
		question: "Is ChatGPT really free on Corvos?",
		answer:
			"Yes. Corvos gives you free access to ChatGPT (GPT-4), Claude AI, Gemini, and other models without login. You get 500,000 free tokens across any model with no sign-up required.",
	},
	{
		question: "How do I use ChatGPT no login?",
		answer:
			"Go to any model page on Corvos and start typing your message. There is no login wall, no account creation, and no verification step. ChatGPT no login works instantly in your browser.",
	},
	{
		question: "What AI models can I use for free without login?",
		answer:
			"Corvos offers free access without login to models from OpenAI (GPT-4, GPT-4 Turbo), Anthropic (Claude 3, Claude free), Google (Gemini), DeepSeek, Mistral, Llama, and more. All available as a free ChatGPT alternative online with no login required.",
	},
	{
		question: "What happens after I use my free tokens?",
		answer:
			"After your free tokens, create a free Corvos account to unlock $5 of premium credit. Additional credit can be topped up at $1 for $1 of credit, billed at the actual provider cost. Non-premium models remain unlimited for registered users.",
	},
	{
		question: "Is Claude AI available without login?",
		answer:
			"Yes. You can use Claude AI free without login on Corvos. Both Claude 3 and other Anthropic models are available with no sign-up, alongside ChatGPT and Gemini.",
	},
	{
		question: "How is Corvos different from ChatGPT?",
		answer:
			"Corvos is an open source NotebookLM alternative that gives you access to multiple AI models in one place without login. Unlike ChatGPT alone, Corvos includes document Q&A with citations, integrations with Slack, Google Drive, Notion, and Confluence, plus team collaboration features.",
	},
	{
		question: "Is Corvos a free ChatGPT alternative?",
		answer:
			"Yes. Corvos is a free, open source alternative to ChatGPT that works without login. It gives you access to Claude AI free, Gemini, and other AI models alongside document Q&A with citations, team collaboration, and 30+ integrations.",
	},
	{
		question: "Is my data private when using free AI chat without login?",
		answer:
			"Anonymous chat sessions are not stored in any database. No account means no personal data collected. Corvos is open source, so you can self-host for complete data control and privacy.",
	},
];
		...
		<div className="min-h-screen pt-20">
			<JsonLd
				data={{
					...
					"@type": "CollectionPage",
					name: "ChatGPT Free Online Without Login - Corvos",
					description:
					...
					mainEntity: {
						...
						itemListElement: seoModels.map((m, i) => ({
							...
							position: i + 1,
							name: m.name,
							url: `https://www.corvos.com/free/${m.seo_slug}`,
						})),
					},
				}}
			/>
			...
			<article className="container mx-auto px-4 pb-20">
				...
				<section className="max-w-4xl mx-auto">
					<h2 className="text-2xl font-bold mb-6">
						Why Use Corvos as Your Free ChatGPT Alternative
					</h2>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						<div className="rounded-lg border bg-card p-5">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								Corvos is a free, open source NotebookLM alternative with document Q&A and
				...
				<section className="max-w-3xl mx-auto text-center">
					...
					<p className="text-muted-foreground mb-6 leading-relaxed">
						Create a free Corvos account to unlock $5 of premium credit, document uploads with
				...
				<nav aria-label="Related pages" className="mt-16 max-w-3xl mx-auto">
					<h2 className="text-lg font-semibold mb-3">Explore Corvos</h2>
