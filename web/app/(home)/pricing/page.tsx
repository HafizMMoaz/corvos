...
const canonicalUrl = "https://www.corvos.com/pricing";

const metaTitle = "Corvos Pricing: Self-Host Free or Pay As You Go";
const metaDescription =
	"Self-host Corvos for free from our open-source repo, or use the cloud with $5 of free credit and pay as you go at provider cost. No subscription.";
...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		siteName: "Corvos",
		type: "website",
		images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Corvos pricing" }],
	},
	twitter: {
