...
const canonicalUrl = "https://www.corvos.com/connectors";

const metaDescription =
	"Platform-native scraper APIs for AI agents. Pull live, structured data from the platforms where answers live through one typed API or the Corvos MCP server. Explore every connector.";

export const metadata: Metadata = {
	title: "Scraper APIs for AI Agents: All Connectors | Corvos",
	...
	openGraph: {
		...
		siteName: "Corvos",
		type: "website",
		images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Corvos connectors" }],
	},
};
			...
			<div className="mx-auto w-full max-w-7xl px-2 md:px-8 xl:px-0">
				<header className="max-w-2xl">
					...
					<p className="mt-5 text-base leading-relaxed text-muted-foreground sm:text-lg">
						...
						through the Corvos MCP server. They are the live data behind the Corvos{" "}
				...
				<div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
					...
					>
						...
						<h2 className="mt-4 text-lg font-semibold">Corvos MCP Server</h2>
						<p className="mt-2 flex-1 text-sm leading-relaxed text-muted-foreground line-clamp-4">
