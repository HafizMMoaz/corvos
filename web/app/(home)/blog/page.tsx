...
export const metadata: Metadata = {
	title: "Blog | Corvos - AI Search & Knowledge Management",
	description: "Product updates, tutorials, and tips from the Corvos team.",
	alternates: {
		canonical: "https://www.corvos.com/blog",
	},
};
