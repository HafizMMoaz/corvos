...
export const metadata: Metadata = {
	title: "Terms of Service | Corvos",
	description: "Terms of Service for the Corvos website and hosted application.",
	alternates: {
		canonical: "https://www.corvos.com/terms",
	},
};

/**
 * Update this date whenever you make a material change to the terms. Keeping
 * it as a static constant (rather than `new Date()`) avoids hydration
 * mismatches and makes the terms look professionally maintained to reviewers.
 */
			...
			<div className="prose dark:prose-invert max-w-none">
				...
				<section className="mb-8">
					...
					<p className="mt-4">
						...
						logos, button icons, images, and data compilations - is the property of Corvos or its
						content suppliers and is protected by international copyright, trademark, and other
						intellectual property laws. (The underlying source code is separately licensed under the{" "}
						<a href="https://github.com/HafizMMoaz/Corvos/blob/main/LICENSE">MIT License</a>.)
					</p>
					<p className="mt-4">
				...
				<section className="mb-8">
					...
					<p className="mt-4 uppercase font-bold">
						IN ALL CASES, CORVOS, AND ITS SUPPLIERS AND DISTRIBUTORS, WILL NOT BE LIABLE FOR ANY
				...
				<section className="mb-8">
					...
					<p>
						You agree to defend, indemnify, and hold harmless Corvos, its affiliates, and their
				...
				<section className="mb-8">
					...
					<p className="mt-4">
						...
						Corvos and you. They do not create any third-party beneficiary rights.
					</p>
					<p className="mt-4">
