...
const STEPS = [
	{
		...
		description:
			"Lets Corvos capture a region of your screen, full display, or browser (where supported) to attach to chat in Screenshot Assist, or to capture the full display from the composer.",
	...
	},
	{
		...
		title: "Accessibility",
		description:
			"Lets Corvos bring the app to the foreground and work with the active application (for example Quick Assist) when you use desktop shortcuts.",
				...
				<div className="text-center space-y-3 shrink-0">
					...
					<div className="space-y-1">
						...
						<p className="text-sm text-muted-foreground">
							Corvos needs two macOS permissions for Screenshot Assist and for desktop features that
									...
									<div className="mt-3 pl-10 space-y-2">
										...
										{status === "denied" && (
											<p className="text-xs text-amber-700 dark:text-amber-400">
												Toggle Corvos on in System Settings to continue.
											</p>
										)}
										<p className="text-xs text-muted-foreground">
											If Corvos doesn&apos;t appear in the list, click <strong>+</strong> and select
