...
export const metadata: Metadata = {
	metadataBase: new URL("https://www.corvos.com"),
	alternates: {
		canonical: "https://www.corvos.com",
	},
	title: "Corvos: Open-Source NotebookLM Alternative & Web Research",
	description:
	...
	openGraph: {
		title: "Corvos - NotebookLM for Open Web Research",
		description:
			"The open-source NotebookLM alternative. Research the open web with live data from Reddit, YouTube, TikTok, Indeed & more, through one platform, API, or MCP server.",
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "Corvos, open-source NotebookLM alternative for AI agents",
			},
		],
		locale: "en_US",
	},
...
export default function RootLayout({
	...
	return (
		<html
			lang="en"
			data-corvos-auth-type={resolveRuntimeAuthUiMode(BUILD_TIME_AUTH_TYPE)}
			suppressHydrationWarning
		>
			<head>
				<Script id="corvos-runtime-auth-init" strategy="beforeInteractive">
