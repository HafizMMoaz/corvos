...
const GITHUB_URL = "https://github.com/HafizMMoaz/Corvos";
		...
		<div className="pb-4">
			...
			<MarketingSection>
				<Reveal>
					...
					<p className="mt-3 max-w-2xl text-muted-foreground leading-relaxed">
						One typed endpoint, one API key. Or add the Corvos MCP server and let your agent call{" "}
				...
				<Reveal>
					<div className="rounded-2xl border bg-card p-8 text-center sm:p-12">
						...
						<p className="mx-auto mt-3 max-w-xl text-muted-foreground leading-relaxed">
							The {content.name} connector is one of many in the Corvos{" "}
