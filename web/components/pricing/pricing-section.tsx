...
const faqData: FAQSection[] = [
	{
		...
		items: [
			{
				question: "What are credits in Corvos?",
				answer:
					"Credits are a single prepaid balance shown in dollars that powers everything in Corvos: platform connector calls, web crawls, document processing, and premium AI models. New accounts start with $5 of free credit. There is one number to watch, and it only moves when you actually use the product.",
			},
			{
			...
			},
			{
				...
				answer:
					"Corvos checks your balance before every billable call, so your wallet can never go negative. When credit runs out, connector calls, crawls, premium model requests, and document processing pause until you top up. Free models and connectors that do not consume credit keep working.",
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					"Yes. Whether your own app calls a connector with your Corvos API key or your agent calls it as a tool through the MCP server, it is the same endpoint, the same per-item rate, and the same credit balance. There is no separate API plan or seat fee.",
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					"You describe the job in plain English and Corvos sets up the agent, no code needed. Agents can watch any page for changes, track mentions on Reddit and YouTube, monitor Google rankings and Maps reviews, then turn what they find into briefs and alerts, and write results back to Notion, Slack, Linear, and Jira.",
			},
		],
	},
	{
		...
		items: [
			{
				...
				answer:
					"Yes. Corvos is open source, and the default self-hosted configuration ships with all credit billing switched off. Scraping, crawling, document processing, and agent runs are limited only by your own infrastructure and the model provider keys you bring.",
			},
			{
		...
		<div className="mx-auto w-full max-w-4xl overflow-hidden px-4 py-20 md:px-8 md:py-32">
			...
			<div className="text-center">
				...
				<p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
					Everything you need to know about Corvos credits and billing. Can&apos;t find what you
					need? Reach out at{" "}
					<a href="mailto:hafizmoazkhalid@gmail.com" className="text-blue-500 underline">
