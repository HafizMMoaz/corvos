...
interface ProviderConnectDialogProps {
	...
	onAddManualPreviewModel?: (modelId: string) => void;
}
...
export function ProviderConnectDialog({
	...
	const modelDescription = (() => {
		...
		if (isVertex) {
			return "Select the models to enable for Vertex AI";
		}
					...
					{!isAzure ? (
						<>
							...
							<ModelsSelectionPanel
								...
								onAddManualModel={onAddManualPreviewModel}
							/>
						</>
					) : null}
				</div>
