...
export function FooterNew() {
	...
	const socials = [
		{
			title: "Twitter",
			href: "https://x.com/HafizMMoaz",
			icon: IconBrandTwitter,
		},
		{
			title: "LinkedIn",
			href: "https://www.linkedin.com/company/corvos/",
		...
		{
			title: "Reddit",
			href: "https://www.reddit.com/r/Corvos/",
			...
			<div className="max-w-7xl mx-auto text-sm text-neutral-600 dark:text-neutral-400 flex sm:flex-row flex-col justify-between items-start  md:px-8">
				<div className="max-w-xs">
					<div className="mr-0 md:mr-4  md:flex mb-4">
						...
						<span className="dark:text-white/90 text-gray-800 text-lg font-bold">Corvos</span>
					</div>
					...
					<div className="mt-4 ml-2">
						&copy; Corvos {new Date().getFullYear()}. All rights reserved.
					</div>
				</div>
