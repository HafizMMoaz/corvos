...
const STEPS = [
	{
		...
		title: "Connect",
		description:
			"Grab one API key and call any connector straight from your own code, or add the Corvos MCP server to Claude, Cursor, or your own agents. Every connector is a REST endpoint and a native agent tool.",
	},
	{
		number: "02",
		title: "Agents gather",
...
export function HowItWorks() {
	return (
		<MarketingSection>
			<Reveal>
				<h2 className="text-2xl font-bold tracking-tight sm:text-3xl">How Corvos works</h2>
			</Reveal>
			<FlowLine />
