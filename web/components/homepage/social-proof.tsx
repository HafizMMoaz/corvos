...
/**
 * Organic Corvos coverage - real posts embedded live with react-social-media-embed,
...
const YOUTUBE: Post[] = [
	{
		...
		title: "Corvos vs NotebookLM",
		channel: "rezasaad plus",
	},
	{
		kind: "youtube",
		url: "https://www.youtube.com/watch?v=VBOwuD6xVK0",
		title: "NotebookLM Is Great… Until You See Corvos",
		channel: "Thomas AI",
	},
	{
		kind: "youtube",
		url: "https://www.youtube.com/watch?v=UaekqjhUiJM",
		title: "NotebookLM vs Corvos en 6 pruebas reales (sorprendente)",
		channel: "NextGen IA Hub",
	},
	{
		kind: "youtube",
		url: "https://www.youtube.com/watch?v=QGjKpZJJ9aw",
		title: "Gana DINERO configurando “Cerebros de IA” privados con Corvos",
		channel: "Creando Con La IA",
	},
	{
		kind: "youtube",
		url: "https://www.youtube.com/watch?v=cfNAIQtNbKY",
		title: "¿Adiós NotebookLM? Probé Corvos y es BRUTAL (IA Gratis)",
		channel: "NextGen IA Hub",
	},
	{
		kind: "youtube",
		url: "https://www.youtube.com/watch?v=pIWOKSHhf38",
		title: "¿Superaron a NotebookLM? Corvos es Open Source, privada y GRATIS",
