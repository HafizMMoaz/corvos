...
export function PersonaPaths() {
	return (
		<MarketingSection>
			<Reveal>
				<h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Who Corvos is for</h2>
			</Reveal>
