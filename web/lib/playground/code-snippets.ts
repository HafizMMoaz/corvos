...
response = requests.post(
    "${url}",
    headers={"Authorization": f"Bearer {os.environ['CORVOS_API_KEY']}"},
    json=${indent(body, 4)},
)
...
client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
    "Bearer", Environment.GetEnvironmentVariable("CORVOS_API_KEY"));
...
request["Authorization"] = "Bearer #{ENV["CORVOS_API_KEY"]}"
