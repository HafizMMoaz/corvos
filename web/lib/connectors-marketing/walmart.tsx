...
export const walmart: ConnectorPageContent = {
	...
	metaTitle: "Walmart API for Product & Review Data | Corvos",
	metaDescription:
		"Scrape public Walmart product and review data with the Corvos Walmart API: prices, ratings, sellers, variants, and full review history as JSON. Start free.",
	keywords: [
		"walmart api",
		"walmart product api",
		"walmart scraper",
	...
	comparison: {
		...
		intro:
			"Most Walmart data APIs bill per request, split product and review data across endpoints, and leave the discovery-to-detail logic to you. Here is how Corvos compares.",
		columnLabel: "Typical Walmart data API",
		rows: [
			{
				feature: "Pricing",
				official: "Per-request pricing that climbs fast at scale",
				corvos: "Pay per product or per review returned, with a free tier to start",
			},
			{
				feature: "Discovery",
				official: "Separate search and detail endpoints you stitch together",
				corvos: "One verb takes search terms or product, search, category, and browse URLs",
			},
			{
				feature: "Reviews",
			...
			},
			{
				...
				corvos: "MCP server exposes walmart.scrape and walmart.reviews as native tools",
			},
		],
	},
	...
	faq: [
		{
			...
			answer:
				"It returns a Walmart listing's data as structured JSON instead of raw HTML. The Corvos Walmart API scrapes public product pages and gives you price, rating, seller, variants, availability, and specifications as clean JSON your agents can read.",
		},
		{
			question: "Does Walmart have an API?",
			answer:
				"Walmart's official APIs - Marketplace and Walmart Connect - are for approved sellers and advertisers, and neither exposes public product or review data at scale. The Corvos Walmart API is an independent alternative: one key, no seller account, and structured public product and review JSON back.",
		},
		{
