...
- CorvosError, HTTPException, validation, and unhandled exceptions all
...
def _make_test_app():
    ...
    @app.get("/corvos-external")
    async def raise_external():
        raise ExternalServiceError()

    @app.get("/corvos-validation")
...
# ---------------------------------------------------------------------------
# CorvosError class hierarchy unit tests
# ---------------------------------------------------------------------------


class TestCorvosErrorClasses:
