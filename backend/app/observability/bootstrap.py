...
def is_otel_disabled() -> bool:
    """Return true when either Corvos or OTel's spec kill switch is set."""
    return _env_truthy("CORVOS_DISABLE_OTEL") or _env_truthy("OTEL_SDK_DISABLED")
...
def _deployment_environment() -> str:
    return os.environ.get("CORVOS_ENV", "dev")
...
def _build_resource():
    ...
    return Resource.create(
        {
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "corvos-backend"),
