...
subagents (see :mod:`app.agents.chat.multi_agent_chat.main_agent.tools.index`).
...
endpoint) lives separately in :mod:`app.agents.chat.multi_agent_chat.shared.tools.catalog`, a
