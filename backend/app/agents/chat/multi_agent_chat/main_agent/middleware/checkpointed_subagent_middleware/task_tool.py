    ...
    def task(
        ...
        if tasks is not None:
            return (
                ...
                "path. Corvos orchestrators always run in an event loop, so "
        ...
        if pending_value is not None:
            resume_value = consume_corvos_resume(runtime)
            if resume_value is None:
                ...
                raise RuntimeError(
                    ...
                    "corvos_resume_value on config; resume bridge is broken."
                )
