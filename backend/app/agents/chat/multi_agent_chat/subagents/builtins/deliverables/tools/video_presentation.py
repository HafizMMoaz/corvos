...
(``CORVOS_SUBAGENT_INVOKE_TIMEOUT_SECONDS`` in multi-agent mode,
...
def create_generate_video_presentation_tool(
    ...
    async def generate_video_presentation(
        source_content: str,
        runtime: ToolRuntime,
        video_title: str = "Corvos Presentation",
        ...
        Args:
            ...
            video_title: Title for the presentation (default: "Corvos Presentation")
