...
from app.agents.chat.multi_agent_chat.subagents.shared.spec import CorvosSubagentSpec
...
def build_subagent(
    *,
    ...
    return CorvosSubagentSpec(spec=spec, ruleset=KB_RULESET)
...
def build_readonly_subagent(
    *,
    ...
    return CorvosSubagentSpec(spec=spec, ruleset=_KB_READONLY_RULESET)
