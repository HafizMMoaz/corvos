...
one format. Corvos-specific extras (FE card discriminator, structured
...
# ``approve_always`` is a Corvos extension surfaced by ``PermissionMiddleware``
...
CORVOS_DECISION_APPROVE_ALWAYS = "approve_always"
    ...
    *,
    ...
    Args:
        ...
        allowed_decisions: Subset of
            ...
            CORVOS_DECISION_APPROVE_ALWAYS]``. Other values are passed through
            but the FE may not render a control for them.
        interrupt_type: Corvos card discriminator (``"gmail_email_send"``,
    ...
    Returns:
        ...
        Corvos extensions (``interrupt_type``, ``context``) sit alongside
...
__all__ = [
    ...
    "LC_DECISION_EDIT",
    "LC_DECISION_REJECT",
    "CORVOS_DECISION_APPROVE_ALWAYS",
