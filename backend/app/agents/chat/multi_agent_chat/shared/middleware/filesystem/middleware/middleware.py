...
class CorvosFilesystemMiddleware(FilesystemMiddleware):
    """Corvos-specific filesystem middleware (cloud + desktop)."""

    state_schema = CorvosFilesystemState
