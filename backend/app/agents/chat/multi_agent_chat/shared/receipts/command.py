...
:class:`~app.agents.chat.multi_agent_chat.shared.state.filesystem_state.CorvosFilesystemState`
...
def with_receipt(
    *,
    ...
    field of :class:`~app.agents.chat.multi_agent_chat.shared.state.filesystem_state.CorvosFilesystemState`,
