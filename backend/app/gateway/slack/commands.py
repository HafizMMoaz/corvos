...
HELP_TEXT = (
    "Corvos Slack commands:\n"
    "`/new` - start a fresh Corvos conversation in this thread\n"
    "`/help` - show this help\n\n"
    "Mention the Corvos bot in a channel thread to ask your agent a question."
)
    ...
    async def send_unbound_onboarding(
        ...
        *,
        ...
        await adapter.send_message(
            ...
            reply_to_message_id=thread_ts,
            text=(
                "Hi! Connect your Slack user to Corvos before using the bot here: "
                f"{dashboard_url}"
            ),
        )
