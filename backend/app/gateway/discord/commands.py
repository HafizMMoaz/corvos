...
HELP_TEXT = (
    "Corvos Discord commands:\n"
    "`/new` - start a fresh Corvos conversation for this Discord thread\n"
    "`/help` - show this help\n\n"
    "Mention the Corvos bot in a Discord channel to ask your agent a question. "
    "Discord search remains controlled by the Discord connector in Corvos."
)
    ...
    async def send_unbound_onboarding(
        ...
        *,
        ...
        await adapter.send_message(
            ...
            reply_to_message_id=message_id,
            text=(
                "Hi! Connect your Discord user to Corvos before using the bot here: "
                f"{dashboard_url}"
            ),
        )
