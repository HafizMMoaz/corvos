...
``backend/`` and prints a short PASS/FAIL/SKIP summary at the
...
# Bootstrap the backend package on sys.path so the script runs
# from the repo root or from `backend/` interchangeably.
