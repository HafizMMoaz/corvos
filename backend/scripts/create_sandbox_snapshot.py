...
Prerequisites:
    - DAYTONA_API_KEY set in backend/.env (or exported in shell)
    - DAYTONA_API_URL=https://app.daytona.io/api
    - DAYTONA_TARGET=us  (or eu)

After this script succeeds, add to backend/.env:
    DAYTONA_SNAPSHOT_ID=corvos-sandbox
"""
