...
const HomePage = () => {
	...
	const saveDatamessage = async () => {
		...
		toast({
			...
			description: "Saving captured content to Corvos",
		});
				...
				<div className="flex flex-1 items-center justify-center p-4">
					<div className="w-full max-w-md space-y-8">
						<div className="flex flex-col items-center space-y-2 text-center">
							...
							<h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Corvos</h1>
				...
				<div className="container mx-auto max-w-md p-4">
					<div className="flex items-center justify-between border-b border-gray-700 pb-4">
						<div className="flex items-center space-x-3">
							...
							<h1 className="text-xl font-semibold text-white">Corvos</h1>
						</div>
