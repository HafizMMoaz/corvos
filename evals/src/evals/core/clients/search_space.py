...
* ``backend/app/routes/search_spaces_routes.py:116`` (POST create)
* ``backend/app/routes/search_spaces_routes.py:234`` (GET by id)
* ``backend/app/routes/search_spaces_routes.py:422`` (DELETE soft-delete)
* ``backend/app/routes/model_connections_routes.py`` (GET/PUT model roles)
* ``backend/app/schemas/search_space.py:14`` (SearchSpaceCreate body)
