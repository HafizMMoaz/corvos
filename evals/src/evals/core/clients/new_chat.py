...
* ``backend/app/routes/new_chat_routes.py:793-848`` (POST /threads)
* ``backend/app/routes/new_chat_routes.py:1073-1142`` (DELETE /threads/{id})
* ``backend/app/routes/new_chat_routes.py:1689-1800`` (POST /new_chat SSE)
* ``backend/app/routes/new_chat_routes.py:191-220`` (THREAD_BUSY / TURN_CANCELLING 409)
* ``backend/app/services/streaming/envelope/sse.py`` (wire framing)
* ``backend/app/services/streaming/events/text.py`` (text-delta events)
* ``backend/app/schemas/new_chat.py:234-288`` (NewChatRequest body)
