...
* Create a fresh ``NewChatThread`` on the suite's pinned SearchSpace.
  ...
  serialises turns, see ``backend/app/routes/new_chat_routes.py:191-220``).
* POST ``/api/v1/new_chat`` with the prompt and the per-question
  ``mentioned_document_ids`` (``backend/app/schemas/new_chat.py:241-243``).
