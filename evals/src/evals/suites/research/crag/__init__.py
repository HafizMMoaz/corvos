...
Why CRAG demonstrates Corvos more clearly than FRAMES
--------------------------------------------------------
FRAMES tested Corvos vs. *no retrieval at all* - a fair "naive
...
* ``corvos``     - POST ``/api/v1/new_chat`` with retrieval scoped
  to the question's 5 ingested pages (``mentioned_document_ids``).

So the headline becomes "Corvos vs. context-stuffed long-context
