...
from ...core.client import CorvosClient
...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    """Register the knowledge-base read tools."""

    @mcp.tool(
        name="corvos_search_knowledge_base",
    ...
    async def search_knowledge_base(
        ...
        stored in Corvos - notes, uploaded files, saved pages, past
    ...
    async def list_documents(
        ...
        about a topic, prefer corvos_search_knowledge_base. Returns each
    ...
    async def get_document(
        ...
        Use this after corvos_search_knowledge_base or
        corvos_list_documents to open a specific document - search results
