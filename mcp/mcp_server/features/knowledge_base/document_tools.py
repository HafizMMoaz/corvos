...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    ...
    async def add_document(
        ...
        on disk use corvos_upload_file instead. Indexing is asynchronous,
    ...
    async def upload_file(
        ...
        for text you already have in hand use corvos_add_document instead.
    ...
    async def update_document(
        ...
        corvos_get_document and resend the combined text. Search chunks are
