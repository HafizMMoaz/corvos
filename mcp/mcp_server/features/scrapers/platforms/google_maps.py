...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    ...
    @mcp.tool(
        name="corvos_google_maps_scrape",
    ...
    async def google_maps_scrape(
        ...
        reviews use corvos_google_maps_reviews instead.
    ...
    @mcp.tool(
        name="corvos_google_maps_reviews",
    ...
    async def google_maps_reviews(
        ...
        place_ids: Annotated[
            list[str] | None,
            Field(description="Google place ids from corvos_google_maps_scrape."),
        ] = None,
        ...
        from corvos_google_maps_scrape first if you only have a name.
