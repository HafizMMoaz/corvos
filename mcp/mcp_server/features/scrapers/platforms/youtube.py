...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    ...
    async def youtube_scrape(
        ...
        corvos_youtube_comments instead. Returns per-video metadata (title,
    ...
    async def youtube_comments(
        ...
        corvos_youtube_scrape if you only have a topic. Returns comment
