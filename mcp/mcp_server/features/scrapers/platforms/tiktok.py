...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    ...
    async def tiktok_scrape(
        ...
        corvos_tiktok_user_search. Example: hashtags=['food'], max_items=20.
        """
    ...
    @mcp.tool(
        name="corvos_tiktok_user_search",
