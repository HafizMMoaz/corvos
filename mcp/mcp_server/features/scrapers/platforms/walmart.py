...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    ...
    async def walmart_scrape(
        ...
        corvos_walmart_reviews instead.
    ...
    async def walmart_reviews(
        ...
        or item_ids from corvos_walmart_scrape first if you only have a name.
