...
def register(mcp: FastMCP, client: CorvosClient, context: WorkspaceContext) -> None:
    ...
    async def instagram_scrape(
        ...
        profile's metadata use corvos_instagram_details. Returns per-item
    ...
    async def instagram_details(
        ...
        For a feed of posts use corvos_instagram_scrape instead. Each item
