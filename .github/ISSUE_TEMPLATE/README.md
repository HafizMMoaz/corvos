...
Thank you for contributing to Corvos! To help us address your issue efficiently, please follow these guidelines:
...
- `cloud` - For issues on Corvos Cloud (hosted version)
...
- **Questions?** Use [GitHub Discussions](https://github.com/Corvos/Corvos/discussions)
- **Security Issues?** Please report privately to the maintainers
- **General Chat?** Join our community channels

Thank you for helping make Corvos better! 🎉
