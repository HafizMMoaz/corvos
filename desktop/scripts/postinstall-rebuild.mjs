...
if (process.platform !== 'darwin') {
  console.log('[corvos-desktop] Skipping electron-rebuild on non-macOS (native permissions module is darwin-only).');
  process.exit(0);
}
...
if (!existsSync(bin)) {
  console.warn('[corvos-desktop] electron-rebuild not found in node_modules/.bin, skipping.');
  process.exit(0);
}
