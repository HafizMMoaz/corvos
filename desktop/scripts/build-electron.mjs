  ...
  const shared = {
    ...
    define: {
      ...
      'process.env.HOSTED_FRONTEND_URL': JSON.stringify(
        process.env.HOSTED_FRONTEND_URL || desktopEnv.HOSTED_FRONTEND_URL || 'https://corvos.com'
      ),
      ...
      'process.env.POSTHOG_HOST': JSON.stringify(
        process.env.POSTHOG_HOST || desktopEnv.POSTHOG_HOST || 'https://assets.corvos.com'
      ),
    },
  };
