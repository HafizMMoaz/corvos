...
const LINUX_DESKTOP_FILENAME = 'corvos.desktop';
...
// ---------------------------------------------------------------------------
// Linux: ~/.config/autostart/corvos.desktop
// ---------------------------------------------------------------------------
...
// First-launch opt-in: register Corvos as a hidden login item so the tray,
